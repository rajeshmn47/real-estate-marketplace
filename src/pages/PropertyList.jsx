...
import {
    ...
    FaBars, FaTimes, FaSpinner, FaCheckCircle
} from 'react-icons/fa';
...
function PropertyList() {
    ...
    const loadProperties = async () => {
        ...
        try {
            ...
            // ✅ Normalize listing type from URL
            ...
            // Update filters with normalized listing type
            if (urlListingType) {
    ...
    useEffect(() => {
        loadProperties();
        fetchFavorites();
    }, [location.search, token, roomType]);
    ...
    // Get available property types based on listing type
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <main className="max-w-7xl mx-auto px-4 py-6">
                <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
                    {/* ===== FILTER SIDEBAR ===== */}
                    <aside className="rounded-2xl bg-white p-6 shadow-sm h-fit sticky top-24">
